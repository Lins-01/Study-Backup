...
class DataArguments:
    ...
    train_path: str = field(default=r'E:\Document\CodeSpace\Study\DeepL\MyProject\2023IKCEST-paddle\train-ocr.json', metadata={"help": "Train dataset file path."})
    dev_path: str = field(default=r'E:\Document\CodeSpace\Study\DeepL\MyProject\2023IKCEST-paddle\val.json', metadata={"help": "Dev dataset file path."})
    test_path: str = field(default=r'E:\Document\CodeSpace\Study\DeepL\MyProject\2023IKCEST-paddle\test.json', metadata={"help": "Test dataset file path."})
    label_path: str = field(default=r'E:\Document\CodeSpace\Study\DeepL\MyProject\2023IKCEST-paddle\train111.json', metadata={"help": "Label file path."})
...
def main():
    ...
    # 定义数据预处理函数
    # functools.partial就是方便输入不同参数调用某个函数，第一个参数是要部分改动的函数，第二个是固定的参数，第三个是可以改的
