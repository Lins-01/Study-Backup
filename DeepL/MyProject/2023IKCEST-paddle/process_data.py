...
#读取数据
import json
data_items_train = json.load(open(r"E:/Document/CodeSpace/Data_set/Paddle2023IKCEST/queries_dataset_merge/dataset_items_train.json",encoding="utf-8"))
data_items_val = json.load(open(r"E:/Document/CodeSpace/Data_set/Paddle2023IKCEST/queries_dataset_merge/dataset_items_val.json",encoding="utf-8"))
...
class NewsContextDatasetEmbs(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.split=='train' or self.split=='val':
            ...
            direct_dict = json.load(open(os.path.join(direct_path_item, 'direct_annotation.json'),encoding="utf-8")) # 每个样本目录下的总json文件
